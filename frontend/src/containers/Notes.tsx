import {useRef, useState, useEffect, MouseEventHandler, FormEventHandler, ChangeEventHandler} from "react";
            ...
            {note && (
                <Form onSubmit={handleSubmit}>
                    ...
                    <div className="d-grid gap-2">
                        ...
                        <LoaderButton size="lg" variant="danger" onClick={handleDelete} isLoading={isDeleting}>
                            Delete
                        </LoaderButton>
                    </div>
                </Form>
