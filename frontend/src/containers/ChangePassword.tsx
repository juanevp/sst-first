...
export default function ChangePassword() {
    ...
    function validateForm() {
        return (
            fields.oldPassword.length > 0 && fields.password.length > 0 && fields.password === fields.confirmPassword
        );
    }

    const handleChangeClick: FormEventHandler = async event => {
        ...
        <div className="ChangePassword">
            <form onSubmit={handleChangeClick}>
                ...
                <div className="d-grid gap-2">
                    <LoaderButton type="submit" size="lg" disabled={!validateForm()} isLoading={isChanging}>
                        Change Password
                    </LoaderButton>
                </div>
            </form>
